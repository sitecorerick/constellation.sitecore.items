namespace Diamond.Views
{
		...
		where TModel : class
	{
		...
		public Item GetItem()
		{
			...
			{
				return DatasourceResolver.Resolve(DataSource.Replace("$site", global::Sitecore.Context.Site.Name), global::Sitecore.Context.Database);
			}
		...
		public Item[] GetItems()
		{
			...
			{
				var query = DatasourceResolver.EncodeQuery(DataSource);
